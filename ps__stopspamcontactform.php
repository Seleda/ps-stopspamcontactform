...
class Ps__stopspamcontactform extends Module
{
    ...
    {
        $this->name = 'ps__stopspamcontactform';
        $this->tab = 'others';
        $this->version = '1.0.0';
        $this->author = 'Seleda';
        ...
        $this->displayName = $this->l('Preventing spam from the contact form');
        $this->description = $this->l('Preventing spam from the contact form');
    ...
    {
        Configuration::deleteByName('STOPSPAMCONTACTFORM_AUTH');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitPs__stopspamcontactformModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitPs__stopspamcontactformModule';
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    array(
                        'type' => 'switch',
                        'label' => $this->l('Send messages only to authorized users'),
                        'name' => 'STOPSPAMCONTACTFORM_AUTH',
                        'is_bool' => true,
                        'values' => array(
                            array(
                                'id' => 'active_on',
    ...
    {
        return array(
            'STOPSPAMCONTACTFORM_AUTH' => Configuration::get('STOPSPAMCONTACTFORM_AUTH', true),
        );
    }
